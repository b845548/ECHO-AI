...
public class AIMLSet extends HashSet<String> {
    ...
    public  void writeAIMLSet () {
        ...
        try{
            // Create file
            FileWriter fstream = new FileWriter(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath()+"/"+bot.sets_path+"/"+setName+".txt");
   ...
   InputStream fstream = new FileInputStream(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath()+"/"+bot.sets_path+"/"+setName+".txt");
