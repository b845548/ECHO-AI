package com.hbbproject.echo .alice;
...
import com.hbbproject.echo.BrainLogger;
...
//    public String bot_name_path = bot_path+"/super";
    public String bot_name_path = "custom";
...
//        }
    ...
    int addCategoriesFromAIML() {
        ...
        try {
File f = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath()+"/"+aiml_path);
    ...
    public int addCategoriesFromAIMLIF() {
        ...
        try {
            ...
            File f = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath()+"/custom/aimlif");
            String[] listOfFiles =f.list();         
...
//            Alice.getContext().getAssets().open(aimlif_path + "/" + fileName + MagicStrings.aimlif_file_suffix);
            ...
            ArrayList<Category> certainCategories = readIFCategories("/custom/aimlif"+  "/" + fileName + MagicStrings.aimlif_file_suffix);
...
//        dir.setLastModified(new Date().getTime());
   ...
   /* public void writeUnfinishedIFCategories() {
    ...
    public void writeIFCategories (ArrayList<Category> cats, String filename)  {
        ...
        File existsPath = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath()+"/"+aimlif_path);
        if (existsPath.exists())
        try {
            //Construct the bw object
            bw = new BufferedWriter(new FileWriter(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath()+"/"+aimlif_path+"/"+filename)) ;
        ...
        for (Category c : brainCategories) {
            try {
                ...
                if (fileMap.containsKey(fileName)) bw = fileMap.get(fileName);
                    ...
                    bw = new BufferedWriter(new FileWriter(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath()+"/"+aimlif_path+"/"+fileName+MagicStrings.aimlif_file_suffix));
        ...
        for (Category c : brainCategories) {
            ...
            try {
                ...
                if (fileMap.containsKey(fileName)) bw = fileMap.get(fileName);
                    ...
                    bw = new BufferedWriter(new FileWriter(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath()+"/"+aiml_path+"/"+fileName));
                    fileMap.put(fileName, bw);
...
//            String[] listOfFiles = Alice.getContext().getAssets().list(maps_path);
            ...
            File f = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath()+"/custom/maps");
            String[] listOfFiles =f.list();         
