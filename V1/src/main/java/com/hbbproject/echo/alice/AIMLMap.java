...
public class AIMLMap extends HashMap<String, String> {
    ...
    public String put(String key, String value) {
       ...
       public  void writeAIMLMap () {
           ...
           try{
               // Create file
               FileWriter fstream = new FileWriter(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath()+"/"+bot.maps_path+"/"+mapName+".txt");
    ...
    public int readAIMLMap (Bot bot) {
        ...
        try {
         ...
         InputStream fstream = new FileInputStream(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath()+"/"+bot.maps_path+"/"+mapName+".txt");
