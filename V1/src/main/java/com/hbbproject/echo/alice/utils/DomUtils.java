package com.hbbproject.echo.alice.utils;
...
public class DomUtils {
    ...
    private static String getFileFromAssets(String fileName){
        ...
        try {
            ...
            InputStream inputStream = new FileInputStream(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath()+"/"+fileName);
